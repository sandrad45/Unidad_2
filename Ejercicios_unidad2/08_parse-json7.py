...
Fecha: 25/oct/2022
Descricpción: En este septimo ejercicio solo agregaremos un elif para mostrar posibles errores a la hora
de saber más. 
'''
import urllib.parse
...
if json_status == 0:
    ...
    '''una función elif que verifique json_status = 402 y muestre un mensaje'''
        ...
        '''agregue una instrucción else que finalice el ciclo if y cubra todos los demás valores de json_status'''
        print("**********************************************")
